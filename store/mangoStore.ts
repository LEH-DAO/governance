...
const initMangoClient = (
  ...
  return MangoClient.connect(provider, CLUSTER, new PublicKey("LehFymqUgQkZyUD2JedHgbTEcHNseyuLnWotwG7zPBB"), {
...
export type MangoStore = {
  ...
  tradeForm: TradeForm
  tradingView: {
    orderLines: Map<string | BN, unknown>
    tradeExecutions: Map<string, unknown>
  }
  wallet: {
    tokens: TokenAccount[]
    nfts: {
