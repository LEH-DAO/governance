...
const TABS = ['activity:swaps', 'activity:trades']

const HistoryTabs = () => {
  const { t } = useTranslation(['common', 'account', 'activity', 'trade'])
  const [activeTab, setActiveTab] = useState<string>('activity:swaps')
    ...
    <>
      <div className="relative max-w-full">
        <SecondaryTabBar
          ...
          tabs={TABS}
        />
        <div className="flex items-center justify-end border-b border-th-bkg-3 py-3 pr-4 sm:-mt-14 sm:h-14 sm:border-b-0 sm:py-0 md:pr-6">
          {!isUnownedAccount ? (
            <LinkButton
