      ...
      {(isOnboarded || query.walletSwap) && walletIcon ? (
        <div className="flex">
          <button
            ...
            className="relative flex h-16 py-2 text-white before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-th-bkg-4 before:to-transparent before:opacity-0 hover:overflow-hidden hover:before:-translate-x-full hover:before:animate-[shimmer_0.75s_normal] hover:before:opacity-100 focus-visible:bg-th-bkg-4 disabled:cursor-wait disabled:opacity-25"
          >
          ...
          <Popover>
            {({ open }) => (
              <>
                <Popover.Button
                  className={`flex h-16 w-10 items-center justify-center rounded-none border-l border-th-bkg-4 text-th-fgd-3 hover:brightness-[1.1] focus:outline-none focus-visible:bg-th-bkg-4`}
                >
                  <ChevronDownIcon
        ...
        <button
          className="relative h-16 rounded-none bg-gradient-to-bl px-6 font-display text-base text-th-fgd-1 before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-th-bkg-4 before:to-transparent before:opacity-0 hover:cursor-pointer hover:overflow-hidden hover:before:-translate-x-full hover:before:animate-[shimmer_0.75s_normal] hover:before:opacity-100"
