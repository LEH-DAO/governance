...
function MyApp({ Component, pageProps }: AppProps) {
  ...
  const endpoint = "https://mainnet.helius-rpc.com/?api-key=b8799404-5d91-4182-94b0-d2a0c3fde271"
    ...
    <>
      ...
      <QueryClientProvider client={queryClient}>
        <ConnectionProvider endpoint={endpoint}>
          ...
          >
            <MangoProvider />
            <ThemeProvider defaultTheme="Lehman Brothers Classic" storageKey={THEME_KEY}>
              <PageTitle />
              <Layout>
                <Telemetry />
                <Component {...pageProps} />
